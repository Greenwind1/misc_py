...
class Model(BaseModel):
    ...
    def build_graph(self, hparams):
        ...
        self.emb_v2 = tf.get_variable(
            shape=[hparams.hash_ids, hparams.feature_nums, hparams.k],
        ...
        emb_inp_v2 = tf.reduce_sum(
            emb_inp_v2 * tf.transpose(emb_inp_v2, [0, 2, 1, 3]), -1)
        ...
        dnn_input = tf.reshape(dnn_input, [tf.shape(emb_inp_v2)[0],
